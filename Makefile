...
CFLAGS16=-s -wx -ms -zl -zq #Stack overflow protection off, warning level max, small memory model, do not link anything from c, run quietly
...
$(BUILD_DIR)/kernel.bin:
	...
	$(LD16) NAME $(BUILD_DIR)/kernel.bin FILE \{$(BUILD_DIR)/kernel/asm/main.onj $(BUILD_DIR)/kernel/asm/print.obj $(BUILD_DIR)/kernel/c/main.obj $(BUILD_DIR)/kernel/c/stdio.obj \} OPTION MAP=${BUILD_DIR}/kernel.map @${SRC_DIR}/kernel/linker.lnk
